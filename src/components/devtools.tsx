...
function DevToolsToggle({ tools }: DevToolsToggleProps) {
  return (
    <Panel position="top-left" className="bg-white p-1 border border-neutral-200 rounded shadow-sm dark:bg-neutral-950 dark:border-neutral-800">
      <ToggleGroup type="multiple">
        {tools.map(({ active, setActive, label, value }) => (
          <ToggleGroupItem
            ...
            aria-pressed={active}
            className="bg-white text-neutral-950 transition-colors duration-300 hover:bg-neutral-100 hover:text-neutral-900 dark:bg-neutral-950 dark:text-neutral-50 dark:hover:bg-neutral-800 dark:hover:text-neutral-50"
          >
            {label}
          </ToggleGroupItem>
        ))}
  ...
  return (
    <>
      ...
      {viewportLoggerActive && (
        <Panel position="bottom-left" className="text-neutral-900 dark:text-neutral-50">
          <ViewportLogger />
        </Panel>
      )}
    </>
